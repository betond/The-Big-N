...
<div class="container pt-4 text-center">
        <h3>Hola <?php echo $dataArray['Nombre'] ?>:</h3>
</div>
<div class="form-control container">
    <form  method="post" name="Formulario" id="form" >
        <fieldset>
            <legend><strong>Identidad:</strong></legend>
            <label for="nboleta">No. de boleta:</label>
                <input type="text" name="nboleta" id="nboleta" value='<?php echo $dataArray['Id'] ?>'  size="12" maxlength="12" disabled>
                <br><br>
            ...
            <label for="fNacimieno">Fecha de nacimiento:</label>
                <input type="date" name="fNacimiento" value='<?php echo $dataArray['FechaN'] ?>' size="30" id="fNacimiento" disabled>
                <br><br>
            ...
            <input type="text" name="curp" id="curp" size="20" value='<?php echo $dataArray['CURP'] ?>'  maxlength="18" disabled>
            <br>
        </fieldset>
        <fieldset>

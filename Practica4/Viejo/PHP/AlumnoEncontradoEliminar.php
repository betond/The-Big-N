...
<head>
    ...
    <title>Confirmar Alumno a Eliminar</title>
...
<div class="container pt-4 text-center">
        <h3>Hola administrador estas seguro de eliminar el siguiente usuario:</h3>
</div>
<div class="form-control container">
    <form  method="post" action="Sentencias/Eliminar.php" name="Formulario" id="form" >
        <fieldset>
        ...
        <input class=".pos-boton" id="enviar" type="submit" value="          Eliminar          ">

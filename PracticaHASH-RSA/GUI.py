...
class GUI:
    ...
    def __init__(self):
        ...
        self.ventana = Tk()
        self.ventana.title("INTEGRIDAD Y AUTENTICACIÓN")
        ...
        self.titulo = Label(self.frame, text="INTEGRIDAD Y AUTENTICACIÓN", font=("consolas", 16, "bold"),
        ...
        self.encryptGUI_btn = Button(self.btn_frame, text="CIFRAR", relief=tkinter.GROOVE,
                                        font=("Helvetica", 10, "bold"),
                                        bd=5, activeforeground="#F50743", activebackground="pink", overrelief="raised",
                                        command=lambda: self.generateActionFrame("CIFRAR")
                                        )
        self.encryptGUI_btn.pack()
        self.encryptGUI_btn.place(rely="0.2", relx="0.3")

        # BOTON PARA CREAR EL FRAME DE WIDGETS PARA DESCIFRAR
        self.decryptGUI_btn = Button(self.btn_frame, text="VERIFICAR", relief=tkinter.GROOVE,
                                        font=("Helvetica", 10, "bold"),
                                        bd=5, activeforeground="#F50743", activebackground="pink", overrelief="raised",
                                        command=lambda: self.generateActionFrame("VERIFICAR")
                                        )
